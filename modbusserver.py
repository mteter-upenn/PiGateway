...
class ThreadedModbusRequestHandler(socketserver.BaseRequestHandler):
    def handle(self):
        ...
        if _debug: ThreadedModbusRequestHandler._debug('incoming modbus request in process %s: %s', cur_process, data)
        ...
        if _debug: ThreadedModbusRequestHandler._debug('response to modbus request in process %s: %s', cur_process,
                                                       response)
